...
#define UI_10_FONT_ID (-498983666)
#define UI_12_FONT_ID (-396463235)
#define UI_14_FONT_ID (598125052)
#define UI_16_FONT_ID (-981254173)
#define UI_18_FONT_ID (1080573083)
#define HEADER_FONT_ID (805326220)
#define SCRIPT_FONT_ID (568551684)
#define SCRIPT_SMALL_FONT_ID (-1504672579)
#define SMALL_FONT_ID (-900541715)
#define MICRO_FONT_ID (696743162)
