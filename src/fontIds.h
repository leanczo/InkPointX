...
#define LOCKSCREEN_CLOCK_FONT_ID (-2069865841)
#define LOCKSCREEN_DATE_FONT_ID (-934264852)
...
static_assert(LOCKSCREEN_CLOCK_FONT_ID != 0, "Font ID collision with sentinel");
static_assert(LOCKSCREEN_DATE_FONT_ID != 0, "Font ID collision with sentinel");
