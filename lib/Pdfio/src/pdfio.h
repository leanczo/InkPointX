...
extern pdfio_file_t	*pdfioFileOpenIO(const char *name, pdfio_input_read_cb_t read_cb, pdfio_input_seek_cb_t seek_cb, pdfio_input_close_cb_t close_cb, pdfio_xref_cb_t xref_cb, void *input_ctx, pdfio_password_cb_t password_cb, void *password_data, pdfio_error_cb_t error_cb, void *error_data) _PDFIO_PUBLIC;
