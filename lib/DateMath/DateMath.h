...
// unit-tested on the host. Only the Gregorian calendar is modeled; epoch day
// 0 is 1970-01-01 to match time_t day-numbering, even though nothing here
// touches time_t directly.
namespace DateMath {
