...
class SdCardFont {
 public:
  ...
  int prewarm(const char* utf8Text, uint8_t styleMask = 0x0F, bool metadataOnly = false, bool preserveExisting = false);
  ...
  bool hasPrewarmedGlyphs(const char* utf8Text, uint8_t styleMask = 0x0F, bool metadataOnly = false) const;
